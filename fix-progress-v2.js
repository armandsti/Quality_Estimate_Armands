...
// Fix the critical conditions - both upload and home page overrides
content = content.replace(
  "} else if (currentPath === '/upload' && view !== 'upload') {",
  "} else if (currentPath === '/upload' && view !== 'upload' && !isLoading) {"
);

content = content.replace(
  "} else if (currentPath === '/' && view !== 'upload' && errors.length === 0) {",
  "} else if (currentPath === '/' && view !== 'upload' && !isLoading && errors.length === 0) {"
);

// Fix the renderView condition
content = content.replace(
